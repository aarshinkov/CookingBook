...
public abstract class Food implements IShowStep {
    private int indexOfStep;
    private List<String> stepList = new ArrayList<>();
    private List<String> ingredientsList = new ArrayList<>();
    private List<String> tempIngrList = new ArrayList<>();
    ...
    private String getIngredientText(List<String> targetList) {
    ...
    protected void setStepList(List<String> stepList) {
